  ...
  <section v-if="stay">
    ...
    <div class="stay-details main-layout">
      ...
      <section class="main-details-container flex">
        ...
        <section class="order-form-mobile-footer">
          <stay-order-form-mobile :stayId="stay._id"></stay-order-form-mobile>
        </section>
      </section>
      <hr class="margin" />
...
import stayOrderFormMobile from '../cmps/stay-order-form-mobile.vue';
